  ...
  return (
    <footer className="bg-black/30 backdrop-blur-lg py-16 px-8 md:px-16 border-t border-gray-700/50">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        >
          <h3 className="text-2xl font-bold mb-4">CASSIDYFX</h3>
        ...
        >
          ...
          <div className="flex flex-col space-y-3">
            <Input
              ...
              className="rounded-full bg-gray-800/50 border-gray-600/50 text-white placeholder-gray-400 backdrop-blur-sm"
            />
            <Button className="bg-purple-600/90 hover:bg-purple-700/90 rounded-full py-6 text-lg backdrop-blur-sm">
              Subscribe
            </Button>
